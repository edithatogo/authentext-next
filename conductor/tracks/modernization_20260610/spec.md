...
- [ ] Pattern catalog reflects upstream v2.8.0 (33 upstream patterns mapped into the local module structure) with adopt/defer decisions recorded for upstream issues #137, #130, #93.
